Contributing to PIASA Core
============================

The PIASA Core project operates an open contributor model where anyone is
...
The following applies to code changes to the PIASA Core project, and is not to be
confused with overall PIASA Network Protocol consensus changes.

Whether a pull request is merged into PIASA Core rests with the project merge
...
Patches that change PIASA consensus rules are considerably more involved than
...
Where a patch set proposes to change the PIASA consensus, it must have been
...
The project leader is the release manager for each PIASA Core release.
