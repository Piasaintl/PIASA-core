...
RESOURCES += src/qt/piasa.qrc src/qt/piasa_locale.qrc

TRANSLATIONS += src/qt/locale/piasa_bg.ts \
                src/qt/locale/piasa_de.ts \
                src/qt/locale/piasa_en.ts \
                src/qt/locale/piasa_es.ts \
                src/qt/locale/piasa_fi.ts \
                src/qt/locale/piasa_fr.ts \
                src/qt/locale/piasa_it.ts \
                src/qt/locale/piasa_ja.ts \
                src/qt/locale/piasa_pl.ts \
                src/qt/locale/piasa_pt.ts \
                src/qt/locale/piasa_ru.ts \
                src/qt/locale/piasa_sk.ts \
                src/qt/locale/piasa_sv.ts \
                src/qt/locale/piasa_vi.ts \
                src/qt/locale/piasa_zh_CN.ts \
                src/qt/locale/piasa_zh_TW.ts
