...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000b39d22edba55b8eb08b6fd64dff33c3e5847a2307574cc7cb8359eea1b2"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1559117934, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1559117934;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 720998;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000b39d22edba55b8eb08b6fd64dff33c3e5847a2307574cc7cb8359eea1b2"));
        assert(genesis.hashMerkleRoot == uint256("0xe51820175ad8e526aeaec71a6b445bd87512f4cdd11513165eb65ce46a818e0c"));

	    vSeeds.push_back(CDNSSeedData("seed1", "seed1.piasa.io"));
        vSeeds.push_back(CDNSSeedData("seed2", "seed2.piasa.io"));
        vSeeds.push_back(CDNSSeedData("seed3", "seed3.piasa.io"));
        ...
        strObfuscationPoolDummyAddress = "P1WnPZxsmjd8xJDGGJ3hk1mJ1txcGvXSr9";
        nStartMasternodePayments = 1559117934;
...
public:
    CTestNetParams()
    {
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet piasa addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet piasa script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet piasa BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet piasa BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet piasa BIP44 coin type is '1' (All coin's testnet default)
        ...
        strObfuscationPoolDummyAddress = "px87cG8UEQgzs1Bk67Yk884C7pnQfAeo7q";
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // PIASA: 1 day
        nTargetSpacing = 1 * 60;        // PIASA: 1 minutes
