...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("PIASA Core piasa-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  piasa-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded piasa transaction") + "\n" +
                               "  piasa-tx [options] -create [commands]   " + _("Create hex-encoded piasa transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded piasa transaction
