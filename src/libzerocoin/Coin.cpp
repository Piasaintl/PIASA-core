...
void PrivateCoin::mintCoin(const CoinDenomination denomination) {
	// Repeat this process up to MAX_COINMINT_ATTPIASATS times until
	// we obtain a prime number
	for(uint32_t attempt = 0; attempt < MAX_COINMINT_ATTPIASATS; attempt++) {
	...
	// MAX_COINMINT_ATTPIASATS. Throw an exception.
