                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received PIASA from zPIASA"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zPIASA"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zPIASA));
