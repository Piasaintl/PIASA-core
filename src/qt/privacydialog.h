...
public:
    ...
    void setZPIASAControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzPIASA_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzPIASA_clicked();
    void on_pushButtonZPIASAControl_clicked();
