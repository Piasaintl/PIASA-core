...
/** Utility functions used by the PIASA Qt UI.
 */
namespace GUIUtil
{
...
// Render PIASA addresses in monospace font
...
// Parse "piasa:" URI into recipient object, return true on successful parsing
