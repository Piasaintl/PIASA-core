                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("PIASA Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PIASA address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and piasa: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About PIASA Core"), this);
    aboutAction->setStatusTip(tr("Show information about PIASA Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for PIASA"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PIASA addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PIASA addresses"));
    ...
    openAction->setStatusTip(tr("Open a PIASA: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the PIASA Core help message to get a list with possible PIASA command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("PIASA Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PIASA network", "", count));
}
...
{
    QString strTitle = tr("PIASA Core"); // default title
...
/** Creates context menu, its actions, and piasas up all the relevant signals for mouse events. */
