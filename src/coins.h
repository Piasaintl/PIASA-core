...
/** 
    ...
    ****Note - for PIASA we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of piasa coming in to a transaction
