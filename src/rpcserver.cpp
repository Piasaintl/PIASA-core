...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PIASA features */
        {"piasa", "masternode", &masternode, true, true, false},
        {"piasa", "listmasternodes", &listmasternodes, true, true, false},
        {"piasa", "getmasternodecount", &getmasternodecount, true, true, false},
        {"piasa", "masternodeconnect", &masternodeconnect, true, true, false},
        {"piasa", "masternodecurrent", &masternodecurrent, true, true, false},
        {"piasa", "masternodedebug", &masternodedebug, true, true, false},
        {"piasa", "startmasternode", &startmasternode, true, true, false},
        {"piasa", "createmasternodekey", &createmasternodekey, true, true, false},
        {"piasa", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"piasa", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"piasa", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"piasa", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"piasa", "getmasternodescores", &getmasternodescores, true, true, false},
        {"piasa", "mnbudget", &mnbudget, true, true, false},
        {"piasa", "preparebudget", &preparebudget, true, true, false},
        {"piasa", "submitbudget", &submitbudget, true, true, false},
        {"piasa", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"piasa", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"piasa", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"piasa", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"piasa", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"piasa", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"piasa", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"piasa", "checkbudgets", &checkbudgets, true, true, false},
        {"piasa", "mnsync", &mnsync, true, true, false},
        {"piasa", "spork", &spork, true, true, false},
        {"piasa", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"piasa", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use piasad, or the -server option to piasa-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> piasa-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:41412/\n";
}
