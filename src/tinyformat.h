...
// #define TINYFORMAT_USE_VARIADIC_TPIASALATES
...
#if !defined(TINYFORMAT_USE_VARIADIC_TPIASALATES) && !defined(TINYFORMAT_NO_VARIADIC_TPIASALATES)
...
#ifdef TINYFORMAT_USE_VARIADIC_TPIASALATES
